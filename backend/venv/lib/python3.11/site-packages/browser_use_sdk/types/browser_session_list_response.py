...
from .browser_session_item_view import BrowserSessionItemView


class BrowserSessionListResponse(UncheckedBaseModel):
    """
    Response model for paginated browser session list requests.
    """

    items: typing.List[BrowserSessionItemView] = pydantic.Field()
    """
